            ...
            <section className='bg-[#120B48]'>
                  <div className='container flex-col text-center justify-center lg:items-start space-y-12 lg:space-y-0  md:flex-row py-20 flex md:justify-between p-12 md:w-[90%]   lg:w-[80%] mx-auto'>
                        ...
                        <ul className='text-white space-y-6'>
                              ...
                              <li className='text-sm'> Converter</li>
                        ...
                        <ul className='text-white space-y-6'>
                              ...
                              <li className='text-sm'>Privay Policy</li>
                        </ul>

                        <ul className='text-white space-y-6'>
                              <li className='font-bold'>Screen Record</li>
                              <li className='text-sm'>Browser Window</li>
                              <li className='text-sm'>Desktop</li>
                              <li className='text-sm'>Application</li>
                        </ul>
